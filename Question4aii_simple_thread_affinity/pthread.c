...
void set_scheduler(void)
{
    ...
    //Set attribute variable fifo_sched_attr
    pthread_attr_init(&fifo_sched_attr);
    //set the created attribute using attr take their scheduling attributes
    //This is set so that you can choose the scheduling policy
